...
public class Person {
    ...
    // Polymorphic info method
    public String getInfo(int currentYear) {
        return "Name: " + name + ", Email: " + email + ", Age: " + getAge(currentYear);
    }
}
...
class Student extends Person {
    ...
    @Override
    public String getInfo(int currentYear) {
        return super.getInfo(currentYear) + ", Student ID: " + studentId + ", Major: " + major;
    }
}
...
class Professor extends Person {
    ...
    @Override
    public String getInfo(int currentYear) {
        return super.getInfo(currentYear) + ", Employee ID: " + employeeId + ", Department: " + department;
    }
}
